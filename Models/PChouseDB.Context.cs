...
namespace Project14.Models
{
    ...
    public partial class PChouseDBEntities : DbContext
    {
        public PChouseDBEntities()
            : base("name=PChouseDBEntities")
        {
        }
        ...
        public virtual DbSet<table_PaymentLog> table_PaymentLog { get; set; }
        public virtual DbSet<table_Product> table_Product { get; set; }
        public virtual DbSet<table_ShipmentLog> table_ShipmentLog { get; set; }
        public virtual DbSet<table_ShoppingCart> table_ShoppingCart { get; set; }
    }
}
